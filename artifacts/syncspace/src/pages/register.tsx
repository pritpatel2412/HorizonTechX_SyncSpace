    ...
    <div className="min-h-screen bg-[#07080a] text-[#cdcdcd] flex flex-col justify-center items-center p-4 selection:bg-white/10 selection:text-white">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-semibold tracking-tight text-[#f4f4f6]">Create an account</h1>
          <p className="text-[#9c9c9d] text-sm mt-1">Join SyncSpace today</p>
        </div>
        ...
        <div className="bg-[#0d0d0d] border border-[#242728] rounded-[10px] p-6 shadow-none">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="name" className="text-xs font-semibold text-[#f4f4f6]">Full Name</Label>
              <Input 
                id="name" 
                value={name} 
          ...
          <div className="mt-6 text-center text-xs text-[#9c9c9d]">
            ...
            <Link href="/login" className="text-white hover:underline font-medium" data-testid="link-login">
              Sign in
            </Link>
          </div>
        </div>
